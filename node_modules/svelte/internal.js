...
function beforeUpdate(fn) {
	exports.current_component.$$.before_render.push(fn);
}

function onMount(fn) {
	exports.current_component.$$.on_mount.push(fn);
}

function afterUpdate(fn) {
	exports.current_component.$$.after_render.push(fn);
}

function onDestroy(fn) {
	exports.current_component.$$.on_destroy.push(fn);
}
...
function init(component, options, instance, create_fragment, not_equal$$1) {
	const previous_component = exports.current_component;
